...
void rng()
{
    ...
    {
        dayChange();
        cout << i << ". " << "\033[34m" << day << "\033[32m" << lines[i] << "\033[0m" << endl;
...
{
    dayNum = 0;
    cout << endl << "\033[31m" << "Enter 1 to edit..." << "\033[0m" << endl;
    cout << "\033[31m" << "Enter 2 to export..." << "\033[0m" << endl;
    cin >> choice;
    if (choice == 1)
        {
            plan.close();
...
void AddMeal()
{
    ...
    { 
        ...
        {
            file << add << "\n";
            cout << "\033[32m" << "Meal added succesfully" << "\033[0m" << endl;
        }
    }
...
void ViewMeals()
{
    fstream file;
        ...
        cout << "\033[32m" << "Your current saved meals are:" << "\033[0m" << endl << endl;
        string line;
        while (getline(file, line)) 
        {
            cout << line << endl;
        ...
        {
            cout << endl << "\033[31m" << "1. Exit" << "\033[0m" << endl;
            cin >> choice;
            if (choice == 1)
            {
                exit;
